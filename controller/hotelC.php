...
$hotelM = new HotelM();
if(isset($_POST["nohotel"]) && in_array($_POST["nohotel"],$hotelM->getAllIdHotel())) $infoHotel=$hotelM->getHotel($_POST["nohotel"]); else echo "<script src='assets/js/gestion404.js'></script><script></script><script>document.addEventListener('DOMContentLoaded', function() {redirection404('Hotel inconnu');});</script>";
