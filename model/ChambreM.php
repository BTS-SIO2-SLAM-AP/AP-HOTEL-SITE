...
class ChambreM extends DBModel
{
	...
	public function getChambresHotel($nohotel) {
        $requete = "select nochambre from chambre where nohotel = $nohotel order by nochambre";
    ...
    {
        $requete = "select reserver.nochambre from reserver inner join reservation on reserver.noresglobale = reservation.noresglobale where reservation.noresglobale=$noresglobale;";
